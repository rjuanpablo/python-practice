...
def superposicion_any(lista_1: Iterable[Any], lista_2: Iterable[Any]) -> bool:
    ...
    #Determina si hay algún elemento en común entre dos listas
    return any(item_1 in lista_1 for item_1 in lista_2)
...
def superposicion_set(lista_1: Iterable[Any], lista_2: Iterable[Any]) -> bool:
    ...
    #Determina si hay alguna intersección (elementos comunes) entre dos listas
